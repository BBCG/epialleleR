...
<svg
   width="56.936001mm"
   height="21mm"
   viewBox="0 0 56.936 21"
   version="1.1"
   id="svg756"
   sodipodi:docname="epialleleR_logo.svg"
  ...
  <sodipodi:namedview
     ...
     inkscape:cx="188.82287"
     inkscape:cy="26.078684"
  ...
  <path
     style="fill:#5fbcd3;stroke:none;stroke-width:0.21906px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
     d="m 40.515647,4.3526783 h 13.918387 c 2.393248,0.014557 2.008086,0.3991514 2.008086,-1.9117631 0,-0.9582834 -0.749872,-1.91174853 -2.008086,-1.91174853 H 40.515647 c -1.258215,0 -2.01126,0.95346513 -2.008071,1.91174853 0.0029,0.9534506 0.756189,1.9117631 2.008071,1.9117631 z"
     id="path29078" />
  <path
     style="fill:#5fbcd3;stroke:none;stroke-width:0.21906px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
     d="m 40.515647,9.744846 h 13.918387 c 1.251896,0 2.008086,-0.9582977 2.008086,-1.911763 0,-2.3109436 0.385162,-1.9257961 -2.008086,-1.9117486 H 40.515647 c -1.258215,0 -2.01126,0.953465 -2.008071,1.9117486 0.0029,0.9534509 0.756189,1.911763 2.008071,1.911763 z"
     id="path29080" />
  <path
     style="fill:#5fbcd3;stroke:none;stroke-width:0.21906px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
     d="M 40.515647,15.137014 H 48.2716 c 1.251897,0 2.004927,-0.958298 2.008086,-1.911763 0.0029,-0.958284 -0.749872,-1.911749 -2.008086,-1.911749 h -7.755953 c -1.258215,0 -2.01126,0.953465 -2.008071,1.911749 0.0029,0.95345 0.756189,1.911763 2.008071,1.911763 z"
     id="path29082" />
  <text
     xml:space="preserve"
     style="font-size:8.21654px;line-height:1.25;font-family:sans-serif;letter-spacing:0.385152px;word-spacing:0px;stroke-width:0.385152"
     x="109.80785"
     y="15.547413"
     id="text29086"><tspan
       id="tspan29084"
       style="text-align:end;letter-spacing:0.385152px;text-anchor:end;fill:#0088aa;stroke-width:0.385152"
       x="37.704212"
       y="15.547413"
       dy="0"
  ...
  <path
     style="fill:#5fbcd3;stroke:none;stroke-width:0.21906px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
     d="m 40.515647,20.529167 h 3.904419 c 1.251898,0 2.004928,-0.958298 2.008087,-1.911763 0.0029,-0.958284 -0.749872,-1.911749 -2.008087,-1.911749 h -3.904419 c -1.258215,0 -2.01126,0.953465 -2.008071,1.911749 0.0029,0.953451 0.756189,1.911763 2.008071,1.911763 z"
     id="path29088" />
  <path
     style="fill:#5fbcd3;stroke:none;stroke-width:0.21906px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
     d="m 50.529614,20.529167 h 3.90442 c 1.251896,0 2.004927,-0.958298 2.008086,-1.911763 0.0029,-0.958284 -0.749872,-1.911749 -2.008086,-1.911749 h -3.90442 c -1.258214,0 -2.011259,0.953465 -2.008071,1.911749 0.0029,0.953451 0.756189,1.911763 2.008071,1.911763 z"
     id="path29090" />
</svg>
</div>
 ...
 * If methylation call strings are not present in BAM file, *`epialleleR`* can
 make and store such calls in output BAM (similar to Bismark or Illumina's
 mapping/alignment solutions)
...
During methylation calling, human genome (hg38) loading usually takes 10-20
seconds. Using preloaded reference genome, the calling itself is performed
at the speed of 200-300 thousand reads per second (25-40 MB/s of BAM data).
...
For the purposes of testing *`epialleleR`* or other tools for methylation
calling and/or reporting, the package provides a convenient way to manually
create sample BAM files by specifying mandatory and optional BAM file tags.
The following code will create a small BAM file that contains methylation calls
and can be used for methylation reporting as described later:
...
(BAM) files as its input. It is a prerequisite that records in the BAM file
...
If BAM files were produced by other mapping/alignment tools (e.g., bwa-meth)
and lack XG/XM data, it is possible to call methylation using
...
For paired-end alignments, BAM file must be sorted by read name
(and not genomic location). Arbitrary sorting is allowed for single-end
sequencing alignments.

Please use the function help files for a full description of available
parameters, as well as explanation of the functions' logic and output values.
...
If BAM file lacks XG/XM tags (e.g., is an output of bwa-meth), preprocessing
will fail with the message that cytosine methylation calling must be performed.
This can be done as follows:

```{r}
# bwa-meth sample output
input.bam <- system.file("extdata", "test", "bwameth-se-unsort-yc.bam", package="epialleleR")
