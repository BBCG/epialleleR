...
which in case of the paired-end short-read data may be attributed not only to
reference-free processing but also to quality-based read merging
(see *`epialleleR`* publication). When tested on a 5mC subset of Modkit
