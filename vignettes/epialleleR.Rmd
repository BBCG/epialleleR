...
with on-board read mapping/alignment (NextSeq 1000/2000, NovaSeq X). Such BAM
...
For paired-end alignments, BAM file must be also sorted by read name
(and not genomic location).
