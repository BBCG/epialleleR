...
#' the fraction of reads with an average methylation level passing certain
#' threshold.
#'
#' @details
...
#'   \item nreads+ -- number of valid reads (pairs) mapped to the forward ("+")
#'   strand
...
#'   # with read filtering
#'   generateBedReport(bam=temp.bam, bed=temp.bed)
