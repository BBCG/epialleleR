...
rcpp_read_bam_paired <- function(fn, bed, min_mapq, min__baseq, skip_flags, trim5, trim3, nthreads) {
    .Call(`_epialleleR_rcpp_read_bam_paired`, fn, bed, min_mapq, min__baseq, skip_flags, trim5, trim3, nthreads)
}
