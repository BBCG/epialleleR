...
- **[The R Project for Statistical
  Computing](https://www.r-project.org/)** - The foundational
  environment and high-performance computing capabilities.
...
- **[Rcpp](https://github.com/RcppCore/Rcpp)** – Seamless,
  high-performance integration between R and underlying C++ code.
...
- **[Boost C++ Libraries](https://www.boost.org/)** - Peer-reviewed,
  highly efficient portable C++ template libraries.
